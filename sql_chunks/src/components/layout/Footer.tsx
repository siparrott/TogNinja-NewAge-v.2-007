...
import { Facebook, Instagram, Twitter, User, LogIn, Mail, Camera } from 'lucide-react';
    ...
    <footer className="bg-gray-800 text-white mt-12">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          <div className="md:col-span-2">
            <Link to="/" className="flex items-center text-white text-xl font-bold mb-4">
              ...
              <span>New Age Fotografie</span>
            </Link>
            <p className="text-gray-300 mb-4">
              Professionelle Fotografie für besondere Momente in Wien & Zürich.
            </p>
          ...
          <div className="md:col-span-5 mt-8">
            <div className="bg-gray-700 rounded-lg p-6">
              ...
              {error && (
                <p className="mt-2 text-red-400 text-sm">{t('newsletter.error')}</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-300">
          <p>&copy; {currentYear} New Age Fotografie. Alle Rechte vorbehalten.</p>
        </div>
      </div>
    </footer>
  );
