...
import { Menu, User, Globe, Settings } from 'lucide-react';
    ...
    <header className="bg-white shadow-sm sticky top-0 z-10">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <Link to="/" className="flex items-center">
          <img 
            src="https://www.newagefotografie.com/wp-content/uploads/elementor/thumbs/logoL-copy-qu6ldzxtfkv42b15lllr2qiim8w8eahiyelgeykud4.jpg" 
