...
const CustomizationPage: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'theme' | 'email'>('theme');
  const [themeSettings, setThemeSettings] = useState<ThemeSettings>({
    primaryColor: '#8b5cf6',
    secondaryColor: '#4f46e5',
    accentColor: '#ec4899',
    fontFamily: 'Poppins',
    logoUrl: 'https://www.newagefotografie.com/wp-content/uploads/elementor/thumbs/logoL-copy-qu6ldzxtfkv42b15lllr2qiim8w8eahiyelgeykud4.jpg',
    headerStyle: 'light',
    footerStyle: 'dark'
  });
  ...
  const [emailSettings, setEmailSettings] = useState<EmailSettings>({
    ...
    senderEmail: 'info@newagefotografie.com',
    emailSignature: '<p>Best regards,<br>The New Age Fotografie Team</p>',
    emailLogo: 'https://www.newagefotografie.com/wp-content/uploads/elementor/thumbs/logoL-copy-qu6ldzxtfkv42b15lllr2qiim8w8eahiyelgeykud4.jpg'
  });
    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-600">Personalize your website and client communications</p>
        </div>
