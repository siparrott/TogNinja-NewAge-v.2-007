/*
  # Photography Business Enhancements

  1. New Tables
    - `projects` - Photography project management
    - `equipment` - Camera equipment tracking
...
INSERT INTO reviews (client_id, rating, title, review_text, reviewer_name, is_public, is_featured) VALUES
('1', 5, 'Amazing Family Photos!', 'Matt captured our family perfectly. The kids were comfortable and the photos turned out beautiful. Highly recommend!', 'Sarah M.', true, true),
('2', 5, 'Professional Wedding Photography', 'Exceptional service from start to finish. The photos exceeded our expectations and captured every special moment.', 'Michael & Lisa', true, true),
('3', 4, 'Great Newborn Session', 'Very patient with our newborn and created beautiful memories. The studio was warm and comfortable.', 'Anna W.', true, false);