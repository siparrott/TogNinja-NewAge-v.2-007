/*
  ...
  1. New Tables
    ...
    - Creates `gallery_access_logs` table for visitor tracking
  
  2. Security
    - Enables RLS on all tables
    - Adds admin policies with proper checks to prevent duplicates
  
  3. Performance
    - Adds appropriate indexes for efficient queries
*/
