/*
  # Fix gallery_images table migration

  1. Changes
    - Adds conditional checks to prevent policy creation if it already exists
    - Ensures all operations are idempotent (safe to run multiple times)
