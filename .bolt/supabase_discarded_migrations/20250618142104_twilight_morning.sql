/*
  ...
  1. New Tables
    - `blog_posts` - Main blog post table with rich content
    - `blog_tags` - Tag management for categorizing posts
...
GRANT USAGE ON SEQUENCE blog_tags_id_seq TO authenticated;