...
BEGIN
  ...
  SELECT EXISTS (
    ...
    WHERE tablename = 'admin_users' AND polname = 'Service role full access'
  ) INTO policy_exists;
  ...
  SELECT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'admin_users' AND polname = 'Users can read own admin record'
  ) INTO policy_exists;
  ...
  SELECT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'admin_users' AND polname = 'Users can insert own admin record'
  ) INTO policy_exists;
  ...
  SELECT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'admin_users' AND polname = 'Users can update own admin record'
  ) INTO policy_exists;
