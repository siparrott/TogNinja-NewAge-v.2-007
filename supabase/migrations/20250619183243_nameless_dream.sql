/*
  ...
  1. New Table
    ...
    - Includes all necessary columns for image storage and management
  
  2. New Columns
    - Adds `uploaded_at` timestamp column to track when images were uploaded
    - Adds `shared_to_togninja` boolean column to track external sharing status
*/
